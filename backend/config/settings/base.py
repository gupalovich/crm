...
SECRET_KEY = env(
    "DJANGO_SECRET_KEY",
    default="7NVYIDjoAQMQiNv0Koxgxpy0H5USyJF1OcCW3UsfcnEUt66HIKYxBu4fxh5MlQrQ",
)
...
MIGRATION_MODULES = {"sites": "crm.contrib.sites.migrations"}
...
REST_FRAMEWORK = {
    "EXCEPTION_HANDLER": "crm.core.exceptions.drf_default_with_modifications_exception_handler",
