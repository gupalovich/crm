...
# https://storage.yandexcloud.net/crm-stage">
aws_s3_domain = f"{AWS_S3_ENDPOINT_URL}/{AWS_STORAGE_BUCKET_NAME}"

# STATIC
# ------------------------
STORAGES = {
    "default": {
        "BACKEND": "crm.core.storages.MediaRootS3Boto3Storage",
    },
    "staticfiles": {
        "BACKEND": "crm.core.storages.StaticRootS3Boto3Storage",
    },
}
